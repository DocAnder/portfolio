export default function Experiencia() {
  return (
    <div className="flex flex-col sm:flex-row lg:flex-col items-center justify-around gap-6 p-6 bg-black border border-zinc-800 rounded-2xl">
        <Item principal="Desenvolvedor" label="Empresa: Google" />
        <Item principal="Desenvolvedor" label="Empresa: Facebook" />
        <Item principal="Desenvolvedor" label="Empresa: Twitter" />
    </div>
...
function Item(
    props: {principal:string, label:string}
){
    return (
